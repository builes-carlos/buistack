...
aliases: [pm, product lead, product owner, head of product, vp product, director of product, product person]
---
...
| weekly-checkin | Cross-domain pattern analysis — connects product metrics to team health to market shifts |
...
`team` — PMs benefit from delegated deep analysis. Team mode sends research and data gathering to specialist sub-agents, producing more thorough briefs and analyses.
