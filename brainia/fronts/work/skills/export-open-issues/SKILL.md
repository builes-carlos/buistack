...
1. **Read `vault/00-inbox/MY-INTEGRATIONS.md`** to determine which trackers are active
...
Save to: `vault/04-projects/[project]/audits/open-issues-YYYY-MM-DD.md`

```bash
mkdir -p "vault/04-projects/[project]/audits"
```
...
Save to: `vault/04-projects/[project]/audits/open-issues-YYYY-MM-DD.csv`
