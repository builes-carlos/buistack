...
1. **Read `vault/00-inbox/MY-INTEGRATIONS.md`** to determine data sources and publishing options
...
Save to: `vault/04-projects/[project]/release-notes/release-[version]-YYYY-MM-DD.md`

```bash
mkdir -p "vault/04-projects/[project]/release-notes"
```
