...
1. **Read `vault/00-inbox/MY-INTEGRATIONS.md`** to determine publishing options:
...
2. **Read `vault/00-inbox/MY-PROFILE.md`** for:
   - Active projects
...
1. Glob for PRDs: vault/04-projects/*/PRDs/*.md
2. Glob for related project files: vault/04-projects/[project]/**/*.md
...
Check vault/00-inbox/MY-INTEGRATIONS.md for active trackers, then:
...
Save the PRD to: `vault/04-projects/[project]/PRDs/prd-[feature-slug]-YYYY-MM-DD.md`

Create the directory structure if it doesn't exist:
```bash
mkdir -p "vault/04-projects/[project]/PRDs"
```
