...
#### People CRM System
- **`vault/05-knowledge/people/README.md`** — People CRM documentation with design principles, file naming, citation format
...
- **Brain-First Knowledge Protocol** — Read `vault/05-knowledge/` before answering people/project/strategy questions
...
- **`auto-research`** — Deep strategic research engine inspired by Karpathy's autoresearch
  ...
  - Saves to `vault/05-knowledge/research/`
...
- **`generate-prd`** — Draft product requirement documents
  ...
  - Saves to `vault/04-projects/[project]/PRDs/`
- **`generate-release-notes`** — Generate release notes from any source
  ...
  - Saves to `vault/04-projects/[project]/releases/`
- **`export-open-issues`** — Audit and export open issues
  ...
  - Saves structured report to `vault/04-projects/[project]/audits/`
...
- **Vault-first output**: All PM artifacts save to vault (`vault/04-projects/`, `vault/05-knowledge/`) before any external publishing
...
- **Step 5.6 — Integration Discovery**: Presents role pack's recommended integrations with role-specific explanations. Generates `vault/00-inbox/MY-INTEGRATIONS.md` with Active/Disabled sections
...
- `.gitkeep` added to: `vault/00-inbox/`, `vault/01-daily/`, `vault/01-daily/briefs/`, `vault/01-daily/checkins/`, `vault/02-personal/`, `vault/02-personal/braindumps/`, `vault/03-professional/`, `vault/03-professional/braindumps/`, `vault/04-projects/`, `vault/05-knowledge/`, `vault/05-knowledge/consolidated/`, `vault/05-knowledge/patterns/`, `vault/05-knowledge/timeline/`, `vault/05-knowledge/booklets/`, `06-templates/`
...
- **url-dump** - Quick capture URLs with automatic content extraction
  ...
  - Saves to `vault/05-knowledge/booklets/` or project resources
...
- **`vault/00-inbox/MY-PROFILE.md`** - User's basic info, role, and active projects
- **`vault/00-inbox/MY-INTERESTS.md`** - Topics of interest and preferred news sources
- **`vault/03-professional/COMPETITIVE-WATCHLIST.md`** - Companies/people to track
- **`vault/04-projects/[project]/PROJECT-OVERVIEW.md`** - Per-project overview documents
- **`vault/00-inbox/WELCOME-TO-COG.md`** - Personalized welcome guide (auto-generated)
...
- **Directory structure unchanged** - `vault/00-inbox/`, `vault/01-daily/`, etc. remain the same
