...
FRAMEWORK_FILES=(
  ...
  # People CRM
  "vault/05-knowledge/people/README.md"
  "06-templates/people-profile-template.md"

  # Framework config
  "CLAUDE.md"

  # Global guard hook (Claude Code; installed into ~/.claude via global-hooks/install.py)
  "global-hooks/guard-bulk-extraction.py"
