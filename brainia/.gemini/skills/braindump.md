...
## Pre-Flight
1. Read `vault/00-inbox/MY-PROFILE.md` for name, role, projects, agent_mode
2. Read `vault/03-professional/COMPETITIVE-WATCHLIST.md` for tracked entities
...
- **Project-specific** → `vault/04-projects/[project-slug]/braindumps/`
- **Mixed/unclear** → `vault/00-inbox/`
...
If watchlist entities are mentioned, save intel to `vault/04-projects/[project]/competitive/[entity-slug].md`
