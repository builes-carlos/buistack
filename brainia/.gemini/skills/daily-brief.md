...
## Pre-Flight
1. Read `vault/00-inbox/MY-INTERESTS.md` for topics and preferred sources
2. Read `vault/00-inbox/MY-PROFILE.md` for role context and agent_mode
3. Read `vault/03-professional/COMPETITIVE-WATCHLIST.md` for entities to track
...
### 4. Generate Brief
Save to `vault/01-daily/briefs/daily-brief-YYYY-MM-DD.md` with:
```yaml
type: daily-brief
created: YYYY-MM-DD
topics_covered: [list]
