...
2. Scan recent content from the past week:
   - `vault/02-personal/braindumps/` (personal domain)
   - `vault/03-professional/braindumps/` (professional domain)
   - `vault/04-projects/*/braindumps/` (each active project)
   - `vault/01-daily/briefs/` (daily briefs from this week)
...
### 6. Generate Check-in
Save to `vault/01-daily/checkins/weekly-checkin-YYYY-MM-DD.md` with:
```yaml
type: weekly-checkin
created: YYYY-MM-DD
week_rating: N/10
