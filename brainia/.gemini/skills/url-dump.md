...
## Pre-Flight
1. Read `vault/00-inbox/MY-PROFILE.md` for interests, projects, agent_mode
2. Read `vault/00-inbox/MY-INTERESTS.md` for relevance assessment
...
**Project-specific** → `vault/04-projects/[project-slug]/resources/[title-slug].md`
**Unclear** → `vault/00-inbox/[title-slug].md`
