...
- Look for `vault/00-inbox/MY-PROFILE.md`
...
**`vault/00-inbox/MY-PROFILE.md`** with frontmatter:
```yaml
type: profile
created: YYYY-MM-DD
...
**`vault/04-projects/[project-slug]/PROJECT-OVERVIEW.md`** for each mentioned project

### 7. Create Directory Structure
```
vault/00-inbox/, vault/01-daily/briefs/ + checkins/, vault/02-personal/braindumps/ + development/ + wellness/
vault/03-professional/braindumps/ + leadership/ + strategy/ + skills/
vault/04-projects/, vault/05-knowledge/consolidated/ + patterns/ + timeline/ + booklets/, 06-templates/
```

### 8. Create Welcome Guide
Generate `vault/00-inbox/WELCOME-TO-BRAINIA.md` with quick start instructions.
