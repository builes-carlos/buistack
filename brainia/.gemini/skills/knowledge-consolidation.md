...
## Pre-Flight
1. Read `vault/00-inbox/MY-PROFILE.md` for context and agent_mode
2. Identify last consolidation date (check `vault/05-knowledge/consolidated/` for most recent report)
...
**Report** → `vault/05-knowledge/consolidated/consolidation-YYYY-MM-DD.md`
