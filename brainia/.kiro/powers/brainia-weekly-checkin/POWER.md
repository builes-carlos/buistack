...
- Braindumps in `vault/02-personal/`, `vault/03-professional/`, `vault/04-projects/*/braindumps/`
...
`vault/01-daily/checkins/weekly-checkin-YYYY-MM-DD.md`
