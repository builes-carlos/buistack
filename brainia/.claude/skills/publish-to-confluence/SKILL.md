...
1. **Read `vault/00-inbox/MY-INTEGRATIONS.md`** — Confluence MUST be listed under Active Integrations
...
1. Glob for likely matches in vault/04-projects/, vault/05-knowledge/, vault/01-daily/
