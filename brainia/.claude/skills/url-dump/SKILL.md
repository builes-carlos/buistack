...
3. If found:
   ...
   - Check for existing booklet categories in `vault/05-knowledge/booklets/`
...
**Custom Categories:**
- Check `vault/05-knowledge/booklets/` for existing custom categories
...
- **Standard:** `vault/05-knowledge/booklets/[category-slug]/[title-slug]-YYYY-MM-DD.md`
- **Project-specific:** `vault/04-projects/[project-slug]/resources/[title-slug]-YYYY-MM-DD.md`
- **Mixed/Unclear:** `vault/00-inbox/url-[title-slug]-YYYY-MM-DD.md`
