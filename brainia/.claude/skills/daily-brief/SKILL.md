...
1. Look for `vault/00-inbox/MY-PROFILE.md` and `vault/00-inbox/MY-INTERESTS.md` in the vault
2. If NOT found:
   ```
...
3. If found:
   ...
   - Read `vault/03-professional/COMPETITIVE-WATCHLIST.md` if exists for competitive tracking
...
- Read `vault/00-inbox/MY-PROFILE.md` for:
  - User's name
  - User's role/job
  - Active projects

- Read `vault/00-inbox/MY-INTERESTS.md` for:
  - Topics they're interested in
  - Preferred news sources

- Read `vault/03-professional/COMPETITIVE-WATCHLIST.md` (if exists) for:
  - Companies/people to track

#### Deduplication — Previous Brief Scan

Read up to 3 most recent daily briefs from `vault/01-daily/briefs/` (most recent first):
...
Save to: `vault/01-daily/briefs/daily-brief-YYYY-MM-DD.md`
