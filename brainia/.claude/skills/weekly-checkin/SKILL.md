...
- Daily briefs in `vault/01-daily/briefs/`
- Braindumps in `vault/02-personal/braindumps/`, `vault/03-professional/braindumps/`, `vault/04-projects/*/braindumps/`
- Previous check-ins in `vault/01-daily/checkins/`
...
Save to: `vault/01-daily/checkins/weekly-checkin-YYYY-MM-DD.md`
