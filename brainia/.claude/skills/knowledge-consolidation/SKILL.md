...
- All braindumps since last consolidation:
  ...
  - `vault/03-professional/braindumps/`
  - `vault/04-projects/*/braindumps/`
  - `vault/00-inbox/braindump-*.md` (mixed domain)

- Daily briefs and check-ins:
  - `vault/01-daily/briefs/`
  - `vault/01-daily/checkins/`

- Any meeting transcripts or project documents in:
  - `vault/04-projects/*/planning/`
  - `vault/04-projects/*/resources/`
...
Save to: `vault/05-knowledge/consolidated/[framework-name]-framework.md`
...
Save to: `vault/05-knowledge/patterns/pattern-[name].md`
...
Save to: `vault/05-knowledge/timeline/[topic]-evolution-YYYY-MM.md`
...
### Framework 1: [Name]
**Location:** [[vault/05-knowledge/consolidated/[filename]]]
...
**Documentation:** [[vault/05-knowledge/patterns/[filename]]]
...
**Documentation:** [[vault/05-knowledge/timeline/[filename]]]
...
- Location: `vault/00-inbox/archive/`
...
Save to: `vault/05-knowledge/consolidated/consolidation-YYYY-MM-DD.md`
...
`vault/00-inbox/archive/[filename]-archived-YYYY-MM-DD.md`
