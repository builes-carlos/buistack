...
1. Look for `vault/00-inbox/MY-PROFILE.md` in the vault
2. If NOT found:
   ```
...
3. If found:
   ...
   - Read `vault/03-professional/COMPETITIVE-WATCHLIST.md` if it exists for competitive intelligence detection
...
- **Personal:** `vault/02-personal/braindumps/braindump-YYYY-MM-DD-HHMM-<slug>.md`
- **Professional:** `vault/03-professional/braindumps/braindump-YYYY-MM-DD-HHMM-<slug>.md`
- **Project:** `vault/04-projects/[project-slug]/braindumps/braindump-YYYY-MM-DD-HHMM-<slug>.md`
- **Mixed:** `vault/00-inbox/braindump-YYYY-MM-DD-HHMM-<slug>.md`

### 5. Competitive Intelligence Extraction

If competitive intelligence detected (mentions of companies/people from watchlist):

Create/update: `vault/04-projects/[project]/competitive/[company-slug].md`
