...
mkdir -p 00-inbox
mkdir -p vault/01-daily/{briefs,checkins}
mkdir -p vault/02-personal/{braindumps,goals,knowledge,resources}
mkdir -p vault/03-professional/{braindumps,knowledge,meetings,resources}
mkdir -p vault/04-projects/_project-template/{braindumps,competitive,knowledge,meetings}
...
**Action**: Extract competitor information to `vault/04-projects/[project]/competitive/[competitor-name].md`
```
...
**File:** `vault/04-projects/_project-template/README.md`
...
8. `vault/04-projects/_project-template/README.md`
