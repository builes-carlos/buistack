...
## File Structure for Brain (AI-Coached-Life container)
...
│               └── EXAMPLE.md
│
├── vault/00-inbox/                                   # Temporary capture
...
│   ├── meetings/
│   └── resources/
├── vault/04-projects/                                # Project-specific
...
- [ ] `vault/04-projects/_project-template/` - Project folder template
...
5. **Custom projects:** Do you have specific projects to add to vault/04-projects/ now?
